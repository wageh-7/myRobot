...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('new_pkg')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('urdf_file',default_value=os.path.join(bringup_dir, 'urdf', 'Assem1.urdf'),description='Whether to start RVIZ'),
